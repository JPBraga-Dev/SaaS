(() => {
  ...
  function renderSystem() {
    E.systemSettingsContent.innerHTML = `<div class="system-shell"><section class="system-hero"><div class="system-hero-copy"><span class="section-kicker">Configurações gerais</span><h3>${S.settings.systemName}</h3><p>Preferências centrais do ambiente, aparência, alertas e políticas de acesso organizadas para leitura rápida e manutenção contínua.</p></div><div class="system-hero-meta"><span class="meta-chip">Tema <strong>${S.settings.theme === "dark" ? "Escuro" : "Claro"}</strong></span><span class="meta-chip">Idioma <strong>${S.settings.language.toUpperCase()}</strong></span><span class="meta-chip">Timezone <strong>${S.settings.timezone.replace("America/", "")}</strong></span></div></section><div class="system-grid"><div class="system-column"><section class="settings-card" style="--section-index:0"><div class="settings-card-head"><div class="settings-card-title"><span class="section-kicker">Geral</span><h3>Base do sistema</h3><p>Nome da instância, idioma padrão e fuso principal da interface.</p></div><span class="settings-card-badge">Essencial</span></div><div class="settings-card-body"><div class="settings-field-grid"><label class="settings-field-card wide"><span class="field-label">Nome do sistema</span><input class="inline-input" data-setting="systemName" value="${S.settings.systemName}"></label><div class="settings-inline-card"><div class="settings-copy"><span class="setting-label">Idioma</span><span class="setting-meta">Define a linguagem principal da interface.</span></div><div class="segmented-control"><button class="icon-tiny option-chip ${S.settings.language === "pt" ? "active" : ""}" type="button" data-language="pt">PT</button><button class="icon-tiny option-chip ${S.settings.language === "en" ? "active" : ""}" type="button" data-language="en">EN</button></div></div><label class="settings-field-card"><span class="field-label">Timezone</span><select class="inline-select" data-setting="timezone"><option>America/Fortaleza</option><option>America/Sao_Paulo</option><option>UTC</option><option>America/New_York</option></select><span class="setting-help">Usado para datas, horários e eventos exibidos no painel.</span></label></div></div></section><section class="settings-card" style="--section-index:1"><div class="settings-card-head"><div class="settings-card-title"><span class="section-kicker">Aparência</span><h3>Look and feel</h3><p>Ajustes visuais globais com impacto imediato em toda a interface.</p></div><span class="settings-card-badge">Visual</span></div><div class="settings-card-body"><div class="settings-inline-card"><div class="settings-copy"><span class="setting-label">Modo escuro</span><span class="setting-meta">Mantém a identidade dark do Studio Panel com leitura confortável.</span></div><input class="toggle" type="checkbox" id="global-theme-toggle" ${S.settings.theme === "dark" ? "checked" : ""}></div><div class="settings-inline-card"><div class="settings-copy"><span class="setting-label">Raio global</span><span class="setting-meta">Controla o acabamento de cards, inputs e botões.</span></div><div class="segmented-control"><button class="icon-tiny option-chip ${S.settings.radius === "recto" ? "active" : ""}" type="button" data-radius="recto">Reto</button><button class="icon-tiny option-chip ${S.settings.radius === "suave" ? "active" : ""}" type="button" data-radius="suave">Suave</button><button class="icon-tiny option-chip ${S.settings.radius === "arredondado" ? "active" : ""}" type="button" data-radius="arredondado">Arredondado</button></div></div></div></section><section class="settings-card" style="--section-index:2"><div class="settings-card-head"><div class="settings-card-title"><span class="section-kicker">Notificações</span><h3>Preferências de alerta</h3><p>Controle o que chega ao painel sem gerar ruído desnecessário.</p></div><span class="settings-card-badge">Operação</span></div><div class="settings-card-body compact"><label class="settings-inline-card"><div class="settings-copy"><span class="setting-label">Sistema</span><span class="setting-meta">Eventos gerais, alterações de ambiente e confirmações internas.</span></div><input class="toggle" type="checkbox" data-notify-setting="system" ${S.settings.notifications.system ? "checked" : ""}></label><label class="settings-inline-card"><div class="settings-copy"><span class="setting-label">Projetos</span><span class="setting-meta">Acompanhamento de mudanças e eventos relevantes por projeto.</span></div><input class="toggle" type="checkbox" data-notify-setting="projects" ${S.settings.notifications.projects ? "checked" : ""}></label><label class="settings-inline-card"><div class="settings-copy"><span class="setting-label">Segurança</span><span class="setting-meta">Sessões, autenticação e ações críticas de proteção.</span></div><input class="toggle" type="checkbox" data-notify-setting="security" ${S.settings.notifications.security ? "checked" : ""}></label></div></section></div><div class="system-column"><section class="settings-card" style="--section-index:3"><div class="settings-card-head"><div class="settings-card-title"><span class="section-kicker">Integrações</span><h3>Conexões prontas</h3><p>Estrutura visual preparada para conexões externas e pontos de sincronização.</p></div><span class="settings-card-badge">Estrutura</span></div><div class="settings-card-body compact"><div class="integration-list"><article class="integration-card"><div class="integration-top"><span class="integration-icon">W</span><span class="settings-card-badge">Webhook</span></div><div class="settings-copy"><span class="setting-label">Webhooks</span><span class="setting-meta">Canal pronto para receber endpoints, callbacks e eventos assinados.</span></div></article><article class="integration-card"><div class="integration-top"><span class="integration-icon">A</span><span class="settings-card-badge">API</span></div><div class="settings-copy"><span class="setting-label">API externa</span><span class="setting-meta">Espaço reservado para provedores, chaves e autenticações futuras.</span></div></article></div></div></section><section class="settings-card" style="--section-index:4"><div class="settings-card-head"><div class="settings-card-title"><span class="section-kicker">Segurança</span><h3>Ações sensíveis</h3><p>Operações críticas destacadas para reduzir erro e melhorar leitura do risco.</p></div><span class="settings-card-badge">Crítico</span></div><div class="settings-card-body compact"><div class="security-stack"><article class="security-action"><div class="security-top"><div class="settings-copy"><span class="setting-label">Trocar senha</span><span class="setting-meta">Atualize a credencial local do ambiente com um novo valor.</span></div><span class="security-icon">S</span></div><input class="inline-input" type="password" placeholder="Nova senha"></article><article class="security-action danger"><div class="security-top"><div class="settings-copy"><span class="setting-label">Encerrar sessão</span><span class="setting-meta">Finaliza imediatamente a sessão atual deste usuário.</span></div><span class="security-icon">!</span></div><button class="ghost-button full-width" type="button" id="security-logout">Encerrar sessão</button></article></div></div></section></div></div></div>`;
